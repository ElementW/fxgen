...
struct NVarsBlocDesc
{
	eVarType	eVarType;					//!< Type of variables (NByteVarValue, NFloatVarValue ...)
...
public:
	...
	ubyte			GetUByteValue	(udword _idx, float _fTime);	//!< Return variable value
	uword			GetUWordValue	(udword _idx, float _fTime);	//!< Return variable value
	udword		GetUDwordValue(udword _idx, float _fTime);	//!< Return variable value
	float			GetFloatValue	(udword _idx, float _fTime);	//!< Return variable value
	NObject*	GetObjectValue(udword _idx, float _fTime);	//!< Return variable value
	char*			GetStringValue(udword _idx, float _fTime);	//!< Return variable value

	void	SetUByteValue	(udword _idx, float _fTime, ubyte			_val);	//!< Change variable value
	void	SetUWordValue	(udword _idx, float _fTime, uword			_val);	//!< Change variable value
	void	SetUDwordValue(udword _idx, float _fTime, udword		_val);	//!< Change variable value
	void	SetFloatValue	(udword _idx, float _fTime, float			_val);	//!< Return variable value
	void	SetObjectValue(udword _idx, float _fTime, NObject*	_val);	//!< Change variable value
	void	SetStringValue(udword _idx, float _fTime, const char*			_val);	//!< Change variable value
