...
#ifndef min
template<typename T1, typename T2>inline T1 min(T1 t1, T2 t2) { return t1 < t2 ? t1 : (T1)t2; }
#endif

#ifndef max
template<typename T1, typename T2>inline T1 max(T1 t1, T2 t2) { return t1 > t2 ? t1 : (T1)t2; }
#endif
