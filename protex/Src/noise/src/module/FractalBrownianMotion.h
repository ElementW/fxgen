...
#ifndef NOISE_MODULE_FBM_H
#define NOISE_MODULE_FBM_H
  ...
  namespace module
  {
    ...
    class Fbm: public Module
    {
      ...
      protected:
        ...
        double m_pSpectralWeights[FBM_MAX_OCTAVE];
