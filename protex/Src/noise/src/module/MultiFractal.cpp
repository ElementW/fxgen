...
MultiFractal::MultiFractal ():
  ...
  m_octaveCount  (DEFAULT_MULTIFRACTAL_OCTAVE_COUNT),
  m_frequency    (DEFAULT_MULTIFRACTAL_FREQUENCY   ),
  m_lacunarity   (DEFAULT_MULTIFRACTAL_LACUNARITY  ),
  m_noiseQuality (DEFAULT_MULTIFRACTAL_QUALITY     ),
  m_seed         (DEFAULT_MULTIFRACTAL_SEED)
{
	offset = 1.0;
	gain = 2.0;
	exponent = 1.0;
...
void MultiFractal::CalcSpectralWeights ()
{
	...
	for (int i = 0; i < MULTIFRACTAL_MAX_OCTAVE; i++) {
...
double MultiFractal::GetValue (double x, double y, double z) const
{
