...
#ifndef NOISE_MODULE_HETEROTERRAIN_H
#define NOISE_MODULE_HETEROTERRAIN_H
...
namespace noise
{
  ...
  namespace module
  {
    ...
    class HeteroTerrain: public Module
    {
      ...
      public:
        ...
        /// noise::module::HETEROTERRAIN_MAX_OCTAVE.
        ///
        ...
        {
          if (octaveCount > HETEROTERRAIN_MAX_OCTAVE) {
      ...
      protected:
        ...
        double m_pSpectralWeights[HETEROTERRAIN_MAX_OCTAVE];
