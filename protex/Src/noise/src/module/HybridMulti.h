...
#ifndef NOISE_MODULE_HYBRIDMULTI_H
#define NOISE_MODULE_HYBRIDMULTI_H
...
namespace noise
{
  ...
  namespace module
  {
    ...
    /// hybrid-multifractal noise.  hybrid-multifractal noise is generated in
    ...
    ///
    /// hybrid-multifractal noise does not use a persistence value.  This is
    ...
    ///
    /// This noise module outputs hybrid-multifractal-noise values that
    /// usually range from -1.0 to +1.0, but there are no guarantees that all
    /// output values will exist within that range.
    ///
    /// @note For hybrid-multifractal noise generated with only one octave,
    /// the output value ranges from -1.0 to 0.0.
    ///
    /// hybrid-multifractal noise is often used to generate craggy mountainous
    ...
    /// hybrid-multifractal noise.  Adding more octaves increases the detail
    /// of the hybrid-multifractal noise, but with the drawback of increasing
    /// the calculation time.
    ///
    /// An application may specify the number of octaves that generate
    /// hybrid-multifractal noise by calling the SetOctaveCount() method.
    ///
    /// <b>Frequency</b>
    ///
    ...
    /// fractal.c</a> contains the code I used in my hybrid-multifractal class
    ...
    class HybridMulti: public Module
    {
      ...
      public:
        ...
        /// Returns the lacunarity of the hybrid-multifractal noise.
        ///
        /// @returns The lacunarity of the hybrid-multifractal noise.
        /// 
        ...
        /// Returns the quality of the hybrid-multifractal noise.
        ///
        /// @returns The quality of the hybrid-multifractal noise.
        ///
        ...
        /// Returns the seed value used by the hybrid-multifractal-noise
        /// function.
        ///
        ...
        /// Sets the lacunarity of the hybrid-multifractal noise.
        ///
        /// @param lacunarity The lacunarity of the hybrid-multifractal noise.
        /// 
        /// The lacunarity is the frequency multiplier between successive
        /// octaves.
        ///
        ...
        /// Sets the quality of the hybrid-multifractal noise.
        ///
        /// @param noiseQuality The quality of the hybrid-multifractal noise.
        ///
        /// See noise::NoiseQuality for definitions of the various
        /// coherent-noise qualities.
        ...
        /// Sets the number of octaves that generate the hybrid-multifractal
        /// noise.
        ///
        ...
        /// noise::module::HYBRID_MAX_OCTAVE.
        ///
        ...
        /// calculate the hybrid-multifractal-noise value.
        void SetOctaveCount (int octaveCount)
        {
          if (octaveCount > HYBRID_MAX_OCTAVE) {
            throw noise::ExceptionInvalidParam ();
          }
          m_octaveCount = octaveCount;
        }

        /// Sets the seed value used by the hybrid-multifractal-noise
        /// function.
        ///
      ...
      protected:
        ...
        /// Quality of the hybrid-multifractal noise.
        noise::NoiseQuality m_noiseQuality;

        /// Total number of octaves that generate the hybrid-multifractal
        /// noise.
        int m_octaveCount;

        /// Contains the spectral weights for each octave.
        double m_pSpectralWeights[HYBRID_MAX_OCTAVE];
