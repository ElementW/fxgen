#ifndef NOISE_MODULE_PERLINOCTAVE_H
#define NOISE_MODULE_PERLINOCTAVE_H
...
namespace noise
{
  ...
  namespace module
  {
    ...
    class PerlinOctave: public Module
    {
      ...
      public:
		...
		void SetRequiredOctave( int oct ){ m_requiredOctave = oct;m_octaveCount = oct+1; }

      protected:


		/// the required octave
		int m_requiredOctave;
