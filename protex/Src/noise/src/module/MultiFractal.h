...
#ifndef NOISE_MODULE_MULTIFRACTAL_H
#define NOISE_MODULE_MULTIFRACTAL_H
...
namespace noise
{
  ...
  namespace module
  {
    ...
    class MultiFractal: public Module
    {
      ...
      public:
        ...
        /// noise::module::MULTIFRACTAL_MAX_OCTAVE.
        ///
        ...
        {
          if (octaveCount > MULTIFRACTAL_MAX_OCTAVE) {
      ...
      protected:
        ...
        double m_pSpectralWeights[MULTIFRACTAL_MAX_OCTAVE];
