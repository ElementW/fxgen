...
#ifndef NOISE_MODEL_CONCENTRIC_DEPTH_SPHERE_H
#define NOISE_MODEL_CONCENTRIC_DEPTH_SPHERE_H
...
namespace noise
{
  ...
  namespace model
  {
    ...
    /// the origin.
    class ConcentricDepthSphere
    {

      public:

        /// Constructor.
        ConcentricDepthSphere ();

        /// Constructor
        ///
        /// @param module The noise module that is used to generate the output
        /// values.
        ConcentricDepthSphere (const module::Module& module);
