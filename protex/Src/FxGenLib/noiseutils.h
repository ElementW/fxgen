...
namespace noise
{
  ...
  namespace utils
  {
    ...
    /// To make a tileable noise map with no seams at the edges, call the
    /// EnableSeamless() method.
    class NoiseMapBuilderDepthPlane: public NoiseMapBuilder
    {

      public:

        /// Constructor.
        NoiseMapBuilderDepthPlane ();
 ...
 /// Builds a spherical noise map.
    ...
    /// The application must provide the southern, northern, western, and
    /// eastern bounds of the noise map, in degrees.
    class NoiseMapConcentricDepthSphere: public NoiseMapBuilder
    {

      public:

        /// Constructor.
        NoiseMapConcentricDepthSphere ();
		...
		void SetSamplingRadius( double rad ){ m_radius = rad;}
