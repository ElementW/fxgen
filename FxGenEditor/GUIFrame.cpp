...
GUIFrame::GUIFrame( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_toolBarMain = this->CreateToolBar( wxTB_DOCKABLE|wxTB_HORIZONTAL|wxTB_TEXT, wxID_TOOLBARMAIN );
	m_toolBarMain->SetToolBitmapSize( wxSize( 32,32 ) );
	m_toolBarMain->AddTool( wxID_NEW, wxT("New"), wxBitmap( wxT("D:\\Temp\\Cle\\FXGen\\FxGenEditor\\Images\\new.png"), wxBITMAP_TYPE_ANY ), wxNullBitmap, wxITEM_NORMAL, wxEmptyString, wxEmptyString );
	m_toolBarMain->AddTool( wxID_OPEN, wxT("Open"), wxBitmap( wxT("D:\\Temp\\Cle\\FXGen\\FxGenEditor\\Images\\open.png"), wxBITMAP_TYPE_ANY ), wxNullBitmap, wxITEM_NORMAL, wxEmptyString, wxEmptyString );
	m_toolBarMain->AddTool( wxID_SAVE, wxT("Save"), wxBitmap( wxT("D:\\Temp\\Cle\\FXGen\\FxGenEditor\\Images\\save.png"), wxBITMAP_TYPE_ANY ), wxNullBitmap, wxITEM_NORMAL, wxEmptyString, wxEmptyString );
